    ...
    <div class="box">
      ...
      <div class="topbox">
        <div class="curriculumtype">
          ...
          <span v-for="(item,index) in currtype" v-if="isTrue===false" :key="index" :class="clickindex==index?&quot;currsps backblue&quot;:&quot;currsps&quot;"
            @click="bindtap(item,index)">{{ item }}</span>
      ...
      <div class="bottombox">
        <div class="bottomlittle">
          <router-link :to="{path:'detial'}">
              <div class="childrenbox" v-for="(item,index) in options" :key="index">
